...
- **Python package:** `pip install sigtap-agent-tools` — [PyPI](https://pypi.org/project/sigtap-agent-tools/) shim with the free-preview client + challenge decoder (`python -m sigtap_agent_tools.probe` runs all probes)
